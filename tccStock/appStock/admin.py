...
class ProductoAdmin(admin.ModelAdmin):
     ...
     list_filter = ("fecha_entrada", 'categoria')
...
class OrdenSalidaAdmin(admin.ModelAdmin):
    ...
    list_per_page = 50
    list_filter = ("cantidad_producto", 'fecha_creacion', 'cliente_destino')
    #actions = ['delete_selected']
    #actions = None


class OrdenDevolucionAdmin(admin.ModelAdmin):
    list_display = ('numero', 'cantidad_producto', 'fecha_creacion', 'cliente_destino')
    list_per_page = 50
    list_filter = ("cantidad_producto", 'fecha_creacion', 'cliente_destino')
    #actions = ['delete_selected']
